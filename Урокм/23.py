...
#
#     def area(self):
#         print(f'Площадь треугольника {self.color} равна:', end=" ")
...
#
# figur = list()
# figur.append(Line(Point(0, 0), Point(10, 10)))
# figur.append(Line(Point(10, 10), Point(20, 10)))
# figur.append(Rect(Point(50, 50), Point(100, 100)))
# figur.append(Ellipse(Point(-10, -10), Point(10, 10)))
#
# for f in figur:
#     f.draw()
